...
void bowling() {
int tour, now = 0, score = 0; // now - бросок сейчас(начиная с 0, т.к. элементы массива)
for (tour = 1; tour <= 10; tour++) { // тур, начиная с 1

if((throw[now] + throw[now+1] <= 10) && i <= 21) { // если 2 броска в туре не больше 10 и бросков не больше 21
...
6 4 2 5 3 6 8 1 2 1 7 2 6 2 5 4 1 7 6 4 5(21 бросок) = 89(верно) - спейр в 10 туре
*/
}
...
printf("now=%d ", now); // и это
}

else {
    printf("\nВы ввели неправильные значения3!");
    exit(0);
}
...
if ((throw[now-1] == 10) && (i % 2 == 0)) {
    printf("\nСумма очков равна %d", score);
}

else {
    printf("\nВы ввели неправильные значения11!!!");
    exit(0);
    }
}
...
3 страйка + спейр = 17 бросков
3 страйка + спейр в 10 туре = 18 бросков
*/
}
